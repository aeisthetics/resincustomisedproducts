...
while($row=mysqli_fetch_assoc($result_query))
{
  ...
  echo "<div class='product-card image-zoom-effect link-effect d-flex flex-wrap'>
          ...
          while($row=mysqli_fetch_assoc($result_query))
{
  ...
  $productname=$row['productname'];
  $productimage=$row['image'];
  echo "<div class='product-card image-zoom-effect link-effect d-flex flex-wrap  col-md-4 mb-4'  >
              <div class='image-holder'>
                   <div class='product-image img-fluid'>
				            	<a href='single-product.html' ><img src='img/necklace.jpg' alt=''></a>  
                 </div>
