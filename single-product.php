...
<!-- //banner -->
 ...
 <div class="ads-grid_shop">
  <div class="shop_inner_inf">
    <div class="col-md-4 single-right-left ">
      <div class="grid images_3_of_2">
        <div class="flexslider">
          ...
          <ul class="slides">
            <li data-thumb="img/heart.jpg">
              <div class="thumb-image"> <img src="img/heart.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
          </ul>
          <div class="clearfix"></div>
        </div>
    ...
    <h3 class="display-2 text-dark text-uppercase">PENDANT NECKLACE</h3>
    <div class="col-md-8 single-right-left simpleCart_shelfItem">
        <div>
          <h1>customise:</h1>
            ...
            <a class="dropdown-toggle" href="#" id="dropdownPages" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">CHAIN</a>
            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages" >
              <li>
                <input type="checkbox" style="margin-left: 10px;"> GOLD
              </li>
              <li>
                <input type="checkbox" style="margin-left: 10px;" > SILVER            
                 </li>
              
            </ul>
            <br><a class="dropdown-toggle" href="#" id="dropdownPages" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">SHAPE</a>
            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages" >
              <li>
                <input type="checkbox" style="margin-left: 10px;"> ROUND
              </li>
              <li>
                <input type="checkbox" style="margin-left: 10px;" > SQUARE           
                 </li>
              
            </ul>
           <br> <a class="dropdown-toggle" href="#" id="dropdownPages" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">FLOWER</a>
            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages" >
              <li>
                <input type="checkbox" style="margin-left: 10px;"> SMALL
              </li>
              <li>
                <input type="checkbox" style="margin-left: 10px;" > LARGE         
                 </li>
          ...
          <p style="font-family: 'Poppins', sans-serif;"><span >450/-</span>
            <del>650/-</del>
          </p>
           </ul>
        ...
        <div class="resp-tabs-container">
          ...
          <div class="tab1">
            ...
            <div class="single_page">
              ...
              <p>This minimalist pendant necklace features a sleek, understated pendant that adds a touch of elegance to any outfit. The pendant is crafted from high-quality metal and hangs effortlessly from a delicate chain. Its clean, simple design makes it a versatile accessory, perfect for both everyday wear and special occasions.The pendant features a delicate, intricately designed motif that captures light from every angle, creating a subtle shimmer. It acts a versatile accessory that can be worn with both casual and formal attire. The necklace is finished with a secure lobster clasp and an adjustable chain length, allowing for a customized fit.
                Whether you're dressing up for a special occasion or adding a touch of sophistication to your everyday look, this pendant necklace is a stunning choice that will enhance any outfit with its understated grace.</p>
            ...
            <div class="single_page">
              <div class="bootstrap-tab-text-grids">
                ...
                <div class="add-review">
                  <h4>add a review</h4>
                  <form action="#" method="post">
                    <input type="text" name="Name" required="Name" value="name">
                    <input type="email" name="Email" required="Email" value="email address">
          ...
          <div class="tab3">
            ...
            <div class="single_page">
             ...
             <p>Size : 18 inch full length</p>
             <p>Occasion : Perfect for daily usage,also suitable as party wear</p>
             <p>Made from premium quality material,this product assures to remain in its original glory even after years of usage.</p>
            </div>
          </div>
        </div>
      </div>
